/* 
    Fetch 12 random users including name, location, email, picture, cell number, date of birth. 
    Chose to limit to Australian users (for filtering purposes) as I am Aussie.
*/
